...
/**
 * Servlet implementation class marks_adminfill
 */
public class marks_adminfill extends HttpServlet {
	Connection cn = null;
	Statement st = null;
